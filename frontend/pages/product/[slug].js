                            ...
                            <div className="relative">
                                ...
                                <span
                                    ...
                                    <svg fill="none" stroke="currentColor" strokeLinecap="round"
                                        strokeLinejoin="round" strokeWidth="2" className="w-4 h-4" viewBox="0 0 24 24">
                    ...
                    <div className="space-y-4 mb-20">
                        ...
                        <div className='mb-20'>
                            <div className="flex space-x-5 mt-10 ">
                                <Link href={'/cart'}><button onClick={()=>{addtocart(product.attributes,1, product.attributes.price)}}
                                ...
                                <button onClick={()=>{addtocart(product.attributes,1, product.attributes.price)}}
