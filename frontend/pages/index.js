...
<div class="min-h-screen bg-gray-100 flex flex-col justify-center">
  <h1 className="text-5xl ml-40 font-semibold text-green-600">Products</h1>
  <div class="relative m-3 flex flex-wrap mx-auto justify-center mb-20">
      ...
      <div class="mt-4 pl-2 mb-2 flex justify-between ">
        ...
        <section className="text-gray-600 body-font">
          <div className="container px-5 py-24 mx-auto">
            ...
            <Link href={'/categories'}><button className="flex mx-auto mt-16 text-white bg-green-500 border-0 py-2 px-8 focus:outline-none hover:bg-green-600 rounded-full text-lg">
              Shop Now
            </button></Link>
          </div>
        </section>
