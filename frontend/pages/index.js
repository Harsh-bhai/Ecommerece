  ...
  <div className="container px-5 py-24 mx-auto">
    <div className="flex flex-wrap -m-4">
      <div className="p-4 lg:w-1/3">
        <div className="cursor-pointer h-full bg-gray-100 bg-opacity-75 px-8 pt-16 pb-24 rounded-lg overflow-hidden text-center relative">
          ...
          <a className="text-green-700 inline-flex items-center">Learn More
            ...
            <div className="flex flex-wrap -m-4">
              <div className="p-4 lg:w-1/3">
                <div className="cursor-pointer h-full bg-gray-100 bg-opacity-75 px-8 pt-16 pb-24 rounded-lg overflow-hidden text-center relative">
                  ...
                  <a className="text-green-700 inline-flex items-center">
                    Learn More
                    <svg
