...
const Dairyproducts = ({products}) => {
  return (
    <div>
      <section className="text-gray-600 body-font">
            <h1 className="text-5xl text-black m-4 mx-16 mb-8 font-semibold">Dairy Products</h1>
...
export async function getServerSideProps(context) {
  ...
  let a = await fetch(`${process.env.NEXT_PUBLIC_HOST}/api/products?filters[category][$contains]=Dairy&populate=*`, {
    headers: headers,
  });
